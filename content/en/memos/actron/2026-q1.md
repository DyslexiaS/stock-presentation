...
**On chip source, module strategy and timing.** Virtual IDM: Anjet designs, X-Fab and Mosel Vitelic foundry, packaging in-group. Industrial/AI: own-brand modules on own silicon. Auto IGBT: foundry service. Custom modules are furthest along (small shipments this year); discretes are sampling. 2026 contribution small; **2027** is when it should show.

**On exclusive versus multi-source for domestic HVDC.** On the **custom modules** developed with the customer, Actron is **exclusive**. Service appetite versus international IDMs is the stated win condition.

**On how AI revenue will be reported.** Auto versus industrial, with industrial then split by AI, storage, chargers, motor control.

**On whether a named PSU major is a customer.** **No names**, NDAs with every customer. Previously reported identities have not been confirmed. In talks with all major Taiwan power-supply names.

**On HVDC margins.** Cautiously optimistic; custom R&D is heavy, so the hurdle is **at least the current average, possibly better**.
