...
| 連接器 / 線材 | touch-safe 連接器、機械互鎖、液冷電纜 | **貿聯-KY(3665)**、瀚荃(8103)、凡甲(3526)、**良維(6290)**、信邦(3023) | 貿聯 1 篇（2023）、瀚荃 1、良維 1 |
...
| 功率半導體 SiC/GaN | SST 用 SiC、GPU 端 GaN | 環球晶(6488)、漢磊(3707)、嘉晶(3016)、朋程(8255)、捷敏-KY(6525) | 環球晶、漢磊、嘉晶、朋程、捷敏各 1 篇。主題 hub：`/en/topics/sic-gan` |
...
- [x] **良維 6290** — NVIDIA 官方 power-component 名單（Lead Wealth），先前誤標成非台廠。1 篇（2025-12-11）；800V 專案有、不透露客戶與時程。
...
### P2 — 液冷（800V 的雙生問題，官方 NVL72 / NVL144 用 45°C 液冷 + 液冷匯流排）

- [x] **主題 hub** `content/en/topics/liquid-cooling.md` — 官方規格（NVL72 液冷櫃、45°C 迴路、CDU）在前，台廠地圖在後。冷卻主線 dual-tag `liquid-cooling`，不把全部 800V 筆記灌進主題列表。
- [x] 奇鋐 3017 — 英文 2 篇（2026Q1、2026Q2）。2025-05-20 當檔案未翻。
- [ ] 泰碩 3338、樺漢 6414 — 最新場 `transcriptionStatus: failed`，要重跑。樺漢 2024-08-20 是工控 ODM，不是冷卻主線。
- [x] 雙鴻 3324 — 英文 2 篇（2025-05-23 Q1、2025-11-25 Q3）。最新場已 completed。
- [x] 健策 3653 — 英文 1 篇（2025-11-28）。該場沒說 800V；重點是 GPU 水冷出貨與尚未計入展望的 microchannel。
- [x] 富世達 6805 — 英文 1 篇（2026-03-05，Q4/FY2025）。自稱 NVIDIA GB200/GB300 Switch 主力 QD；B/R 水冷板 QD 由 NVIDIA 指定。2026-05-05、2026-08-04 `failed`。
- [x] 尼得科超眾 6230 — 英文 1 篇（2025-08-29，H1）。水冷 2025 年 2–5%、2026 年約 10%；冷板崑山、CDU/QD 在 Nidec 泰國。

### P2b — SiC / GaN（800V 轉換級的化合物開關）

- [x] **主題 hub** `content/en/topics/sic-gan.md` — 官方規格（白皮書只寫 SiC/GaN 成熟度 + EV 800V 前例；官方 silicon 名單沒有台廠化合物）在前，台廠地圖在後。化合物主線 dual-tag `sic-gan`，不把全部 800V 筆記灌進主題列表。
- [x] 漢磊 3707 — 英文 1 篇（2025-09-17 H1）。GaN +11%、SiC −33%；800V 是 2027 600kW 機櫃需求論，不是 design win。官網與 DB 都沒有 2026 法說會；不能用股東會新聞稿充當一場。
- [x] 嘉晶 3016 — 英文 1 篇（2026-04-29 Q1）。GaN 磊晶已進 800V HVDC 小量試產。
- [x] 朋程 8255 — 英文 1 篇（2026-05-26 Q1）。SiC 模組 650–3300V；國內客戶客製 HVDC 獨家、已送樣。
- [x] 捷敏-KY 6525 — 英文 1 篇（2026-03-10 FY2025）。HVDC 是客戶圖面問題；2025 AI 超車是熱封裝。
- [x] 環球晶 6488 — 英文 1 篇（2025-08-18 Q2）。董事長點名 800 伏電源與 AI 機櫃是需求口袋；GaN 滿載、年底 +30% 產能；SiC 價格崩跌、沒有退出。DB 沒有 2025-11-04、2026-08-04 兩場。
- [ ] 合晶 6182 — 2026-08-06 `pending`，等轉錄。
...
- [ ] 盤點 `earnings_call` 的 `failed` / `pending` 文件數量，排重跑優先序（泰碩、樺漢、富世達後兩場最急）。
...
| 液冷（CDU / sidecar / 冷板） | NVIDIA NVL72 45°C 規格、OCP ACS | 138 | 94 |
