...
| 功率半導體 SiC/GaN | SST 用 SiC、GPU 端 GaN | 漢磊(3707)、嘉晶(3016)、朋程(8255)、捷敏-KY(6525) | 漢磊、嘉晶、朋程、捷敏各 1 篇。主題 hub：`/en/topics/sic-gan` |
...
- [x] 漢磊 3707 — 英文 1 篇（2025-09-17 H1）。GaN +11%、SiC −33%；800V 是 2027 600kW 機櫃需求論，不是 design win。
...
- [ ] 環球晶等基板、世界先進（漢磊 8 吋合作對象）— 尚未開英文公司頁。越峰 SiC 粉體留在 800V hub adjacent，不 dual-tag。
