...
| 機櫃組裝 ODM | Kyber / NVL144 整櫃 | 鴻海(2317)、廣達(2382)、緯穎(6669) | 鴻海 3 篇 |
...
- [x] **鴻海 2317** — 3 篇（2023Q3、2024Q3、2025Q1）。2026 的三場 `failed`／`pending`。
- [x] 立錡 — 聯發科子公司、無獨立法說會，已在 hub 說明，不開公司頁。

**P0 剩餘（需要資料，不是需要翻譯）**

- [ ] 重跑鴻海 2026-03-16、2026-05-14、2026-08-12 的轉錄
