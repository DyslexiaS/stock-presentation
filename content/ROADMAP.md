...
| 液冷 | CDU、sidecar、冷板、45°C 迴路、液冷匯流排 | 奇鋐(3017)、雙鴻(3324)、健策(3653)、泰碩(3338)、建準(2421) | 奇鋐 2 篇（2026Q1–Q2）、建準 1 篇（800V EC 風扇） |
...
- [ ] 盤點 `earnings_call` 的 `failed` / `pending` 文件數量，排重跑優先序（雙鴻、泰碩、富世達後兩場最急）。
