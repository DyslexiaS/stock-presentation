...
export async function GET() {
  ...
  const content = [
    ...
    `English briefings of Taiwan-listed company earnings calls, written for overseas investors. Chinese transcripts are not published. ${slugs.length} companies, ${memos.length} notes. Topics: NVIDIA 800V HVDC, AI-rack liquid cooling, SiC/GaN and rack ODM.`,
    ...
    '- Topics covered: NVIDIA 800V HVDC, liquid cooling, SiC/GaN and rack ODM — power racks, BBUs, cold plates, manifolds, QDs, CDUs, rack assembly, epitaxy, foundry, modules, OSAT, leadframes, magnetics, relays, connectors, test gear, facility MV',
    '',
    '### Topic pages',
    ...topics,
    '',
