...
export async function GET() {
  ...
  const content = [
    ...
    `English briefings of Taiwan-listed company earnings calls, written for overseas investors. Chinese transcripts are not published. ${slugs.length} companies, ${memos.length} notes. Topics: NVIDIA 800V HVDC, AI-rack liquid cooling, SiC/GaN, rack ODM and CoWoS.`,
    ...
    `- Liquid cooling Taiwan supply chain: ${EN_BASE_URL}/en/topics/liquid-cooling`,
    `- SiC / GaN Taiwan power semiconductors: ${EN_BASE_URL}/en/topics/sic-gan`,
    `- AI rack ODM Taiwan: ${EN_BASE_URL}/en/topics/rack-odm`,
    `- TSMC CoWoS advanced packaging: ${EN_BASE_URL}/en/topics/cowos`,
    `- English sitemap: ${EN_BASE_URL}/en-sitemap.xml`,
    `- Sitemap index: ${EN_BASE_URL}/sitemap-index.xml`,
    '- Topics covered: NVIDIA 800V HVDC, liquid cooling, SiC/GaN, rack ODM and CoWoS — power racks, BBUs, cold plates, manifolds, QDs, CDUs, rack assembly, epitaxy, foundry, modules, OSAT, CoWoS, test, packaging equipment, leadframes, magnetics, relays, connectors, test gear, facility MV',
    '',
    '### Topic pages',
    ...topics,
    '',
    ...
    '- Weekly calendar: this week\'s Taiwan earnings-call schedule at /calendar (queried from eventDate, not a stored snapshot)',
