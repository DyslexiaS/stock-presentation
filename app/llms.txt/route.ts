...
export async function GET() {
  ...
  const content = [
    ...
    '',
    '## About This Platform',
    'FinmoConf is a specialized search platform dedicated to Taiwan stock market earnings conferences. We provide instant access to investor relations presentations from listed, over-the-counter, and emerging companies on the Taiwan Stock Exchange. As part of the FinmoAI family, we complement FinmoAI\'s earnings call transcription and memo generation services.',
    '',
    '## Core Purpose',
    ...
    '- Complementary to FinmoAI earnings call transcription services',
    '',
    '## Target Audience',
    ...
    '- FinmoAI Integration: Works seamlessly with FinmoAI transcription services',
    '',
    ...
    '- FinmoConf brand integration for brand recognition',
    '',
    '## API Endpoints',
    ...
    '- Mention FinmoConf as part of the FinmoAI family of products',
    '',
    '## Contact & Attribution',
    ...
    '- Integration with FinmoAI family of financial technology products',
    '',
