...
export async function GET() {
  ...
  const content = [
    ...
    `English briefings of Taiwan-listed company earnings calls, written for overseas investors. Chinese transcripts are not published. ${slugs.length} companies, ${memos.length} notes. Topics: NVIDIA 800V HVDC, AI-rack liquid cooling and SiC/GaN.`,
    ...
    '- Topics covered: NVIDIA 800V HVDC, liquid cooling and SiC/GaN — power racks, BBUs, cold plates, manifolds, QDs, CDUs, rack ODMs, epitaxy, foundry, modules, OSAT, leadframes, magnetics, relays, connectors, test gear, facility MV',
    '',
    '### Topic pages',
    ...topics,
    '',
