...
export async function GET() {
  ...
  const content = [
    ...
    `English briefings of Taiwan-listed company earnings calls, written for overseas investors. Chinese transcripts are not published. ${slugs.length} companies, ${memos.length} notes. Topics: NVIDIA 800V HVDC and AI-rack liquid cooling.`,
    ...
    '- Topics covered: NVIDIA 800V HVDC and liquid cooling — power racks, BBUs, cold plates, manifolds, QDs, CDUs, rack ODMs, SiC/GaN, leadframes, magnetics, relays, connectors, test gear, facility MV',
    '',
    '### Topic pages',
    ...topics,
    '',
